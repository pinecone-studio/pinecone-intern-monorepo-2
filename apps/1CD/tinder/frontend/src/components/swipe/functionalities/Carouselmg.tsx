  ...
  return (
    <div className="relative ">
      <Carousel className="w-[375px] h-[750px] ">
        <CarouselContent className="relative mt-20 ml-0 ">
                ...
                <div className="absolute px-6 bottom-16">
                  {index === 0 && (
                    <div className="flex items-center gap-2">
                      <div className="text-4xl font-extrabold text-[#FFFFFF] ">{swiping.name}</div>
                      <div className="text-3xl font-light text-[#FFFFFF] ">{swiping.age}</div>
                    </div>
                  )}
                  {index !== 0 && (
                    <div>
                      <div className="text-3xl text-[#FFFFFF] ">{swiping.name}</div>
                      <div className="flex gap-2 text-sm font-semibold text-[#FFFFFF] f">
        ...
        <CarouselNext className="absolute right-0  bg-[#94999f7d] border-[#505965CC] hover:bg-[#696c6fb7]" />
      </Carousel>
    </div>
  );
};
