...
describe('user profile page', () => {
  ...
  //   cy.get('[data-cy="pro-image"]').should('have.attr', 'src', 'http://example.com/profileImage1.jpg');
  ...
  it.only('2. Should display posts when fetch post successfully', () => {
    cy.visit('/home/erdek');
    cy.get('[data-cy="postNumberDone"]').should('contain', 1);
  });
