...
export const typeDefs = mergeTypeDefs([CommonTypeDefs, authTypeDefs, catTypeDefs, ticketTypeDefs, VenueTypeDefs, eventTypeDefs, OrderTypeDefs, UnitTicketTypeDefs]);
