import { updateEventLow } from '../../../../src/resolvers/mutations/event/update-event-low';
...
describe('update priority of the event', () => {
  it('should update priority of the event', async () => {
    ...
    const result = await updateEventLow!({}, { eventId: '1' }, { userId: '1' }, {} as GraphQLResolveInfo);
  ...
  it('should update priority of the event', async () => {
    ...
    try {
      await updateEventLow!({}, { eventId: '1' }, { userId: '2' }, {} as GraphQLResolveInfo);
    } catch (error) {
