...
const ForgotPassword = () => {
  ...
  <div className=''>
    <div data-cy="Forgot-Password-Page" className='bg-[#27272A]'>
      <Form {...form} >
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-[446px] rounded-2xl bg-[09090B#] mx-auto flex flex-col border-[0.1px] border-slate-400 " data-cy="forgot-password-form">
