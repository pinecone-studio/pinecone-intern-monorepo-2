    ...
    return (
        <div className="flex gap-20">
            <div className="w-[264px]">
                <h3 className="text-lg font-semibold text-gray-500">Policies</h3>
            </div>
            <div className="flex flex-col flex-1 gap-10">
                <div className="flex gap-2">
                    <div className="flex flex-col flex-1 gap-2">
                        <h4 className="text-lg font-semibold text-gray-500">Check-in</h4>
                    ...
                    <div className="flex flex-col flex-1 gap-2">
                        <h4 className="text-lg font-semibold text-gray-500">Check-out</h4>
                        <p className="text-sm font-normal text-[#09090B]">Check-in start time: noon; Check-out end time: 5:30 AM</p>
                        <p className="text-sm font-normal text-[#09090B]">Minimum check-in age: 16</p>
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold text-gray-500">Special check-in instructions</h4>
                ...
                <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold text-gray-500">Access methods</h4>
                    <p className="text-sm font-normal">Staffed front desk</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold text-gray-500">Pets</h4>
                    <p className="text-sm font-normal">No pets or service animals allowed</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold text-gray-500">Children and extra beds</h4>
                ...
                <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold text-gray-500">Property payment types</h4>
                    <div className="flex">
