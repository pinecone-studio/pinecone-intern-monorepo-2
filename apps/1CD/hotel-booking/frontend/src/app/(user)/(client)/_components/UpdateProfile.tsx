    ...
    <div className="flex w-2/3 h-screen" data-cy="Update-Profile-Input-And-Tabs">
      <div className="w-64 p-4">
        <ul className="mt-4 space-y-4">
          <li>
            <label htmlFor="tab-1" className="block px-4 py-2 rounded cursor-pointer hover:bg-gray-200" data-cy="Update-Profile-Click-Tab-Personal-Info">
              Personal Information
            </label>
          </li>
          <li>
            <label htmlFor="tab-2" className="block px-4 py-2 rounded cursor-pointer hover:bg-gray-200" data-cy="Update-Profile-Click-Tab-Contact-Info">
              Contact Info
            </label>
          </li>
          <li>
            <label htmlFor="tab-3" className="block px-4 py-2 rounded cursor-pointer hover:bg-gray-200" data-cy="Update-Profile-Click-Tab-Security-Settings">
              Security & Settings
            </label>
          </li>
        </ul>
