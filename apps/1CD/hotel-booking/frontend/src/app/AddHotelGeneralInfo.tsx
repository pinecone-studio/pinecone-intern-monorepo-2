          ...
          <form data-cy="Hotel-General-Info-Page" onSubmit={formik.handleSubmit} className="text-[#09090B]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2 text-sm">
                ...
                <div>
                  <Input data-cy="Stars-Rating-Input" value={formik.values.starsRating === 0 ? '' : formik.values.starsRating} onChange={formik.handleChange} id="starsRating" />
                  <StarsRating />
                </div>
              </div>
              <div className="flex flex-col gap-2 text-sm">
              ...
              <div className="flex flex-col gap-2 text-sm">
                <div>Rating</div>
                <div>
                  <Input data-cy="Review-Rating-Input" value={formik.values.rating === 0 ? '' : formik.values.rating} onChange={formik.handleChange} id="rating" />
                  <ReviewRating />
                </div>
              </div>
            </div>
