...
export const PopularHotelsPage = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="w-full max-w-7xl mx-auto px-8 py-16">
          {/* Page Header */}
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">All Popular Hotels</h1>
            <p className="text-lg text-gray-600">Discover all the most popular and highly-rated hotels</p>
          </div>
  ...
  // Sort all hotels by rating (highest first)
  const allHotels = [...hotels].sort((a, b) => (b.rating || 0) - (a.rating || 0));
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 text-lg">Showing {allHotels.length} hotels</p>
        </div>
      </div>
    </div>
  );
