...
export const MostBooked = ({ hotels, loading, error }: MostBookedProps) => {
  return (
    <section className="py-12 lg:px-80">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Most booked hotels in Mongolia in past month</h2>
