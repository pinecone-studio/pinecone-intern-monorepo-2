...
describe('HotelDetailsCard Name Access Tests', () => {
  it('handles hotel with missing name property to cover line 28', () => {
    ...
    // Should render without crashing - when name is undefined, React renders nothing for undefined
  ...
  it('handles hotel with null name', () => {
    ...
    // Should render without crashing - when name is null, React renders nothing for null
    const titleElement = screen.getByRole('heading', { level: 3 });
    expect(titleElement).toHaveTextContent('Details');
  });
  ...
  it('handles hotel with empty string name', () => {
    ...
    // Should render without crashing - when name is empty string, React renders nothing for empty string
    const titleElement = screen.getByRole('heading', { level: 3 });
    expect(titleElement).toHaveTextContent('Details');
  });
