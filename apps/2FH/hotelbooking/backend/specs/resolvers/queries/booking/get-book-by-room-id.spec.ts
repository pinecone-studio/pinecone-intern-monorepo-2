...
import { getBookingsByRoomId } from '../../../../src/resolvers/queries/booking/get-book-by-room-id';
...
describe('getBookingsByRoomId resolver', () => {
  ...
  describe('successful execution', () => {
    it('should fetch and return transformed bookings for valid room ID', async () => {
      ...
      // Act
      const result = await getBookingsByRoomId(mockParent, { roomId }, mockContext, mockInfo);
  ...
  describe('error handling', () => {
    it('should throw GraphQLError when transformation fails', async () => {
      ...
      // Act & Assert
      await expect(getBookingsByRoomId(mockParent, { roomId }, mockContext, mockInfo))
        .rejects.toThrow(GraphQLError);
      
      await expect(getBookingsByRoomId(mockParent, { roomId }, mockContext, mockInfo))
        .rejects.toThrow('Failed to fetch bookings by room ID');
    });
