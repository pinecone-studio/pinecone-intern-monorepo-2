...
import { getBookingsByHotelId } from '../../../../src/resolvers/queries/booking/get-book-by-hotel-id';
...
describe('getBookingsByHotelId resolver', () => {
  ...
  describe('successful execution', () => {
    it('should fetch and return transformed bookings for valid hotel ID', async () => {
      ...
      // Act
      const result = await getBookingsByHotelId(mockParent, { hotelId }, mockContext, mockInfo);
  ...
  describe('error handling', () => {
    it('should throw GraphQLError when transformation fails', async () => {
      ...
      // Act & Assert
      await expect(getBookingsByHotelId(mockParent, { hotelId }, mockContext, mockInfo))
        .rejects.toThrow(GraphQLError);
      
      await expect(getBookingsByHotelId(mockParent, { hotelId }, mockContext, mockInfo))
        .rejects.toThrow('Failed to fetch bookings by hotel ID');
    });
