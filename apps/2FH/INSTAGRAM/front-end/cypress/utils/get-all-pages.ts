...
const root = './apps/2FH/INSTAGRAM/front-end/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/2FH/INSTAGRAM/front-end'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
