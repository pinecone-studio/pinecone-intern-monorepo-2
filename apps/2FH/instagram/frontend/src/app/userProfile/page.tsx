          ...
          <div className="flex gap-6 sm:gap-8">
              ...
              <div className="w-24 h-24 sm:w-40 sm:h-40 rounded-full p-[3px] bg-gradient-to-tr from-fuchsia-500 to-yellow-400">
                <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                  <Image
                    ...
                    width={100}
                    height={100}
                    alt={`${mockUserData.username} profile picture`}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                ...
                <button className="px-3 py-1.5 text-sm rounded-xl bg-neutral-100 hover:bg-neutral-200 transition-colors">
                  Edit Profile
                </button>
                <button className="px-3 py-1.5 text-sm rounded-xl bg-neutral-100 hover:bg-neutral-200 transition-colors">
                  Ad tools
              ...
              <div className="mt-4 flex flex-wrap gap-x-8 gap-y-2 text-sm">
                <div><strong>{formatNumber(mockUserData.postsCount)}</strong> posts</div>
                <div><strong>{formatNumber(mockUserData.followersCount)}</strong> followers</div>
                <div><strong>{formatNumber(mockUserData.followingCount)}</strong> following</div>
              </div>
              <div className="mt-4 space-y-1 text-sm leading-6">
                ...
                <a 
                  href={`https://${mockUserData.website}`} 
