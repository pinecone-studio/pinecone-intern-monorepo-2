            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-sm border border-gray-300 bg-gray-50 py-3 px-4 pr-12 text-sm text-gray-900 placeholder:text-gray-500 focus:border-gray-400 focus:bg-white focus:outline-none"
