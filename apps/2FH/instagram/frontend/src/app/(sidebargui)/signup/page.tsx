    ...
    <form className="space-y-2" onSubmit={onSubmit}>
      ...
      <div>
        <input
          ...
          className={`w-full rounded-sm border py-2 px-2 text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none ${
            isUsernameError ? 'border-red-500 bg-red-50 focus:border-red-500' : 'border-gray-300 bg-gray-50 focus:border-gray-400 focus:bg-white'
          }`}
      ...
      <div className="pt-2 text-xs text-gray-500 text-center leading-4 space-y-2">
        <p>
          ...
          <Link href="/help/learn-more" className="text-blue-600 hover:text-blue-800">
            Learn More
          </Link>
        </p>
        <p>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="bg-white py-8 px-8 shadow-sm border border-gray-300 rounded-sm">
          <div className="flex justify-center mb-4">
            <Image src="/Instagram_logo.svg" alt="Instagram" width={175} height={48} className="h-12 w-auto" style={{ filter: 'brightness(0)' }} />
          </div>
          <div className="text-center mb-6 text-gray-600 text-base font-medium">
            <p>Sign up to see photos and videos from your friends</p>
          </div>

          <SignupForm formData={formData} setFormData={setFormData} error={error} setError={setError} loading={loading} onSubmit={handleSubmit} />
        </div>
