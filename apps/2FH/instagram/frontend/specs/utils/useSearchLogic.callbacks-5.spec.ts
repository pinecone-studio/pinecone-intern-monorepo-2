...
describe('useSearchLogic - GraphQL Callbacks Part 5', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    jest.useFakeTimers();
  ...
  it('should call onCompleted callback for removeFromSearchHistory', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Removed from search history:', { removeFromSearchHistory: { success: true } });
