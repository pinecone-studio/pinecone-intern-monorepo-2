...
export const GenderSelection: React.FC = () => {
  const { signupData, handleInputChange, nextStep } = useSignup();
  ...
  const canProceed = !!signupData.gender; // ✅ gender сонгогдсон эсэхийг шалгана
    ...
    <div className="flex flex-col bg-white items-center h-full">
      <div className="w-full max-w-md text-center space-y-4">
        ...
        <div className="text-left w-full">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Gender</h3>
        </div>
        <div className="relative" ref={genderDropdownRef}>
          <input
            type="text"
            value={signupData.gender || ''} // ✅ context-с авна
            onFocus={() => setIsDropdownOpen(true)}
            placeholder={signupData.gender ? '' : 'Select gender'}
