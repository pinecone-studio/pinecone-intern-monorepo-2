...
interface ProfileSectionProps {
  ...
  onProfileDataChange: (_data: ProfileData) => void;
}

export const ProfileSection = ({ onSuccess: _onSuccess, profileData, onProfileDataChange }: ProfileSectionProps) => {
  ...
  const handleInputChange = (field: string, value: string) => {
    ...
    onProfileDataChange(newFormData);
  };
