    ...
    <div className="max-w-3xl">
      ...
      <div className="flex gap-3 mb-8">
        <button
          ...
          className="flex items-center space-x-2 px-5 py-2.5 border-2 border-red-500 text-red-500 rounded-lg font-medium hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
        >
        ...
        <button
          ...
          className="px-5 py-2.5 bg-red-500 text-white rounded-lg font-semibold hover:bg-red-600 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
        >
          Save Images
        </button>
      </div>
