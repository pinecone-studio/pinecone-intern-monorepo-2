  ...
  <div className="text-center mb-4">
    {timer > 0 ? (
      ...
      <button
        onClick={onResend}
        disabled={!canResend}
        className="text-pink-500 hover:text-pink-600 text-sm font-medium disabled:opacity-50"
        data-cy="resend-otp"
      >
        Resend OTP
      </button>
...
const VerifyOtpContent = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-medium mb-2 text-center" data-cy="verify-otp-title">Confirm email</h1>
