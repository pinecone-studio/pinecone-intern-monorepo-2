...
export default function MainLayout({ children, onProfileClick }: MainLayoutProps) {
    const { user } = useUser();
    ...
    const { selectedUser, setSelectedUser, profileData, profileLoading, profileError } = useChat(currentUserId);
