...
export const profileSchema = z.object({
    ...
    bio: z
        .string()
        .max(500, 'Bio хамгийн ихдээ 500 тэмдэгт байх ёстой')
        .optional()
        .or(z.literal('')),

    interests: z
        .string()
        .min(1, 'Сонирхол заавал оруулах ёстой')
        .min(3, 'Сонирхол хамгийн багадаа 3 тэмдэгт байх ёстой')
        .max(200, 'Сонирхол хамгийн ихдээ 200 тэмдэгт байх ёстой'),

    profession: z
        .string()
        .min(1, 'Мэргэжил заавал оруулах ёстой')
        .min(2, 'Мэргэжил хамгийн багадаа 2 тэмдэгт байх ёстой')
        .max(100, 'Мэргэжил хамгийн ихдээ 100 тэмдэгт байх ёстой'),

    work: z
        .string()
        .min(1, 'Ажил/Сургууль заавал оруулах ёстой')
        .min(2, 'Ажил/Сургууль хамгийн багадаа 2 тэмдэгт байх ёстой')
        .max(100, 'Ажил/Сургууль хамгийн ихдээ 100 тэмдэгт байх ёстой'),
    ...
    gender: z
        ...
        .refine((gender) => ['Male', 'Female', 'Both', 'Queer'].includes(gender),
            'Хүйс зөв сонгогдох ёстой'),

    images: z
        .array(z.string())
        .min(1, 'Хамгийн багадаа 1 зураг оруулах ёстой')
        .max(6, 'Хамгийн ихдээ 6 зураг оруулах боломжтой'),

    userId: z
        .string()
        .min(1, 'User ID заавал байх ёстой')
});
...
const createSuccessResult = () => ({ success: true, errors: {} });
...
const createFieldSuccessResult = () => ({ success: true, error: null });
...
export const validateField = (field: keyof ProfileFormData, value: any) => {
    try {
