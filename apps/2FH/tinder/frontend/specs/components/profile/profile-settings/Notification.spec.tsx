...
import { Notification } from '@/components/profile/profile-settings/Notification';
...
describe('Notification Component', () => {
  ...
  it('renders with correct styling and structure', () => {
    ...
    expect(innerContainer).toHaveClass('bg-green-50 border border-green-200 rounded-lg p-4 shadow-lg max-w-6xl');
