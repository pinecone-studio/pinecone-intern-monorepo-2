...
describe('ProfileFilterExample', () => {
    ...
    it('should render filtered profiles when user is interested in males', () => {
        ...
        expect(screen.getByText('User interested in: male')).toBeInTheDocument();
        expect(screen.getByText('Total profiles found: 1')).toBeInTheDocument();
        expect(screen.getByText('Has more profiles: Yes')).toBeInTheDocument();
    ...
    it('should render filtered profiles when user is interested in females', () => {
        ...
        expect(screen.getByText('User interested in: female')).toBeInTheDocument();
        expect(screen.getByText('Total profiles found: 1')).toBeInTheDocument();
        expect(screen.getByText('Has more profiles: Yes')).toBeInTheDocument();
    ...
    it('should render all profiles when user is interested in both', () => {
        ...
        expect(screen.getByText('User interested in: both')).toBeInTheDocument();
        expect(screen.getByText('Total profiles found: 2')).toBeInTheDocument();
        expect(screen.getByText('Has more profiles: Yes')).toBeInTheDocument();
        expect(screen.getByText('John Doe')).toBeInTheDocument();
        expect(screen.getByText('Jane Doe')).toBeInTheDocument();
    });
    ...
    it('should show no profiles message when no profiles match', () => {
        ...
        expect(screen.getByText('Total profiles found: 0')).toBeInTheDocument();
        expect(screen.getByText('Has more profiles: No')).toBeInTheDocument();
