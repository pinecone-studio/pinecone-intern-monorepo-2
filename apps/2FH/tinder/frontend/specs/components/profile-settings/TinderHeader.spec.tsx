...
describe('TinderHeader Component', () => {
  ...
  it('renders notification button with image', () => {
    ...
    expect(notificationImage).toHaveAttribute('src', '/message-square (1).svg');
  ...
  it('applies correct container styling', () => {
    ...
    expect(container).toHaveClass('bg-white px-16 py-3.5');
    expect(container?.querySelector('div')).toHaveClass('max-w-3xl mx-auto px-4');
  });
