...
const root = './apps/2FH/Tinder/Frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/2FH/Tinder/Frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
