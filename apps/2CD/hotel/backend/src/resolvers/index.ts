...
import reviewMutations from './mutations/review/review-mutations';
...
import { updateUserRoleToAdmin } from './mutations/user/update-user-role-to-admin';
import { getAllUsers } from './queries/user/get-all-user';
import { getUserById } from './queries/user/get-user-by-id';
import { reviewQueries } from './queries/review/review-query';
import { mostReviewedHotels } from './queries/review/most-reviewed-hotel';
